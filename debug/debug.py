...
staking_address, staking_private_key = 'atp1zlr7c7gfzk7p7f2da7eldetjq292ga3ramx5qq', 'e3b76d6944109583551c20aa2f71ec6997e8b87db7b6f47a66e351fc6f7e42cb'
tx = SimpleTx(rpc, hrp)
# print(tx.admin.nodeInfo)
tx_cfg = {'gasPrice': 3000000000000000}

node_id = '3d9b3315631962c2b8ea8c999d25b6d25ae29cd0bbcd585e1b2fa04777580d73577c7a39e23e00c1e1699acf8eb2f220d7abc06f716ae65270d550a81f92fcf5'
# print(tx.pip.listGovernParam())

print(tx.platon.getBalance(staking_address))
# print(tx.txpool.content)
# print(tx.platon.getTransactionCount(main_address))

print(tx.pip.submitParam(node_id, '1234888', 'staking', 'stakeThreshold', '15000000000000000000000', staking_private_key, transaction_cfg=tx_cfg))
